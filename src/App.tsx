...
function App() {
	...
	const handleCountry = async (
		...
		if (drop) {
			...
			if (saveLine && savePoint) setSelectedCountry(country);
		}
	};
	...
	const saveImage = async (image: string, type: string): Promise<boolean> => {
		try {
			let url =
				'https://mocionws.info/dbController.php?method=newRecord&table=dubai&type=' +
				type +
				'&source=' +
				ipadSource +
				'&image=' +
	...
	const removeSource = async (raw: string) => {
		try {
			let url = !raw
				? 'https://mocionws.info/dbController.php?table=dubai&source=' +
				  ipadSource +
				  "&method=dropRecord&raw= source='" +
				  ipadSource +
				  "'"
				: 'https://mocionws.info/dbController.php?table=dubai&source=' +
				  ipadSource +
	...
	const Back = async (pos: number) => {
		...
		switch (position) {
			case 1:
				...
				if (drop) await saveImage('wave-' + ipadSource, 'wave');
				break;
			case 2:
				drop = await removeSource('');
				if (drop) await saveImage('wave-' + ipadSource, 'wave');
	...
	const setCollaborative = async (
		...
		if (drop) {
			...
			if (save) setCurrentScreen(screen);
		}
	};
	...
	return (
		<div className='full-frame'>
			{currentScreen === 0 ? (
				<div>
					<Image
						src='/images/frame0.png'
						onClick={() => setCollaborative(1, 'wave-' + ipadSource, 'wave')}
			...
			{currentScreen === 2 ? (
				...
				>
					...
					<div
						...
						style={{ top: '68%', left: '0%', position: 'absolute' }}
					>
							...
							<div className='d-flex'>
								<Dropdown className='me-3'>
									...
									<Dropdown.Menu>
										<Dropdown.Item
											onClick={() => [
												setSelectedProyect('RENEWABLE ENERGY'),
												setCurrentScreen(3),
											]}
										>
											RENEWABLE ENERGY
										...
										<Dropdown.Item
											onClick={() => [
												setSelectedProyect('SUSTAINABLE WASTEWATER MANAGEMENT'),
												setCurrentScreen(3),
											]}
										>
										...
										<Dropdown.Item
											onClick={() => [
												setSelectedProyect('GREEN BUILDING'),
												setCurrentScreen(3),
											]}
										>
											GREEN BUILDING
										...
										<Dropdown.Item
											onClick={() => [
												setSelectedProyect('ENERGY EFFICIENCY'),
												setCurrentScreen(3),
											]}
										>
											ENERGY EFFICIENCY
								...
								<Dropdown>
									<Dropdown.Toggle id='dropdown2' className='custom-dropdown'>
										<Image
											src='images/green/botonmorroco.png'
											alt='Imagen'
											fluid
											onClick={() => [
												handleCountry(
													'MORROCO',
													'line-MORROCO-' + ipadSource,
													'point-morroco'
												),
											]}
										/>
							...
							<div className='d-flex mt-3'>
								<Dropdown className='me-3'>
									<Dropdown.Toggle id='dropdown3' className='custom-dropdown'>
										<Image
											src='images/green/botonfrance.png'
											alt='Imagen'
											fluid
											onClick={() => [
												handleCountry(
													'FRANCE',
													'line-FRANCE-' + ipadSource,
													'point-france'
												),
											]}
										/>
			...
			{currentScreen === 3 ? (
				<div>
					...
					selectedProyect === 'RENEWABLE ENERGY' ? (
						<div>
							<Image
								alt=''
								src='/images/green/UAE/renewable/renewable.png'
								fluid
							/>
							{navegacion()}
							<div>
								<img
									src='images/green/UAE/shams.png'
									alt='Imagen'
									style={{
										width: '41.3%',
										height: '7%',
									...
									onClick={() => [
										handleCompany(4, 'SHAMS', 'box-renergy-' + ipadSource),
									]}
								/>
								<img
									src='images/green/UAE/shuaa.png'
									alt='Imagen'
									style={{
										width: '41.3%',
										height: '7%',
									...
									onClick={() => [
										handleCompany(4, 'SHUAA', 'box-renergy-' + ipadSource),
									]}
								/>
								<img
									src='images/green/UAE/sweihan.png'
									alt='Imagen'
									style={{
										width: '41.3%',
										height: '7%',
									...
									onClick={() => [
										handleCompany(4, 'SWEIHAN', 'box-renergy-' + ipadSource),
									]}
								/>
								<img
									src='images/green/UAE/noor.png'
									alt='Imagen'
									style={{
										width: '41.3%',
										height: '7%',
									...
									onClick={() => [
										handleCompany(4, 'NOOR', 'box-renergy-' + ipadSource),
									]}
								/>
							</div>
						</div>
					...
					<div>
						{selectedCountry === 'UNITED ARAB EMIRATES' &&
						selectedProyect === 'SUSTAINABLE WASTEWATER MANAGEMENT' ? (
							<div>
								<Image
									alt=''
									src='images/green/UAE/water/sustainable.png'
									fluid
								/>
								{navegacion()}
								<img
									src='images/green/UAE/water/botonwater.png'
									alt='Imagen'
									style={{
										width: '69%',
										height: '7%',
						...
						{selectedCountry === 'UNITED ARAB EMIRATES' &&
						selectedProyect === 'GREEN BUILDING' ? (
							<div>
								<Image
									alt=''
									src='images/green/UAE/building/building.png'
									fluid
								/>
								{navegacion()}
								<img
									src='images/green/UAE/building/botonetihad.png'
									alt='Imagen'
									style={{
										width: '83%',
										height: '7%',
									...
									onClick={() => [
										handleCompany(4, 'ETIHAD', 'box-greeb-' + ipadSource),
									]}
								/>
								<img
									src='images/green/UAE/building/botonleed.png'
									alt='Imagen'
									style={{
										width: '83%',
										height: '7%',
									...
									onClick={() => [
										handleCompany(4, 'LEED', 'box-greeb-' + ipadSource),
									]}
								/>
							</div>
						) : null}
						{selectedCountry === 'UNITED ARAB EMIRATES' &&
						selectedProyect === 'ENERGY EFFICIENCY' ? (
							<div>
								<Image
									alt=''
									src='images/green/UAE/efficiency/energy.png'
									fluid
								/>
								{navegacion()}
								<img
									src='images/green/UAE/efficiency/botoncooling.png'
									alt='Imagen'
									style={{
										width: '41.3%',
										height: '7%',
									...
									onClick={() => [
										handleCompany(4, 'PLANT1', 'box-energy-' + ipadSource),
									]}
								/>
								<img
									src='images/green/UAE/efficiency/botonplant.png'
									alt='Imagen'
									style={{
										width: '41.3%',
										height: '7%',
									...
									onClick={() => [
										handleCompany(4, 'PLANT2', 'box-energy-' + ipadSource),
									]}
								/>
							</div>
						) : null}
						{selectedCountry === 'MORROCO' &&
						selectedProyect === 'RENEWABLE ENERGY' ? (
							<div>
								<Image alt='' src='/images/green/MORROCO/renewable.png' fluid />
								{navegacion()}
								<img
									src='/images/green/MORROCO/botonmorroco.png'
									alt='Imagen'
									style={{
										width: '77.73%',
										height: '7%',
						...
						selectedProyect === 'GREEN BUILDING' ? (
							<div>
								...
								{navegacion()}
								<img
									src='/images/green/FRANCE/botonfrance.png'
									alt='Imagen'
									style={{
										width: '55.37%',
										height: '7%',
									...
									onClick={() => [
										handleCompany(4, 'OFFICE', 'box-greeb-' + ipadSource),
									]}
								/>
							</div>
						) : null}
						...
						selectedProyect === 'GREEN BUILDING' ? (
							<div>
								...
								{navegacion()}
								<img
									src='/images/green/USA/hotel.png'
									alt='Imagen'
									style={{
										width: '70%',
										height: '7%',
									...
									onClick={() => [
										handleCompany(4, 'HOTEL', 'box-greeb-' + ipadSource),
									]}
								/>
								<img
									src='/images/green/USA/allsuit.png'
									alt='Imagen'
									style={{
										width: '70%',
										height: '7%',
									...
									onClick={() => [
										handleCompany(4, 'ALLSUITE', 'box-greeb-' + ipadSource),
									]}
								/>
							</div>
						) : null}
				...
				<div>
					...
					{selectedCompany === 'SWEIHAN' ? (
						<div>
							<Image
								alt=''
								src='/images/green/UAE/renewable/sweihan.png'
								fluid
							/>
							{navegacion()}
						</div>
					...
					{selectedCompany === 'PLANT1' ? (
						<div>
							<Image
								alt=''
								src='images/green/UAE/efficiency/plant1.png'
								fluid
							/>
							{navegacion()}
						</div>
					...
					{selectedCompany === 'PLANT2' ? (
						<div>
							<Image
								alt=''
								src='images/green/UAE/efficiency/plant2.png'
								fluid
							/>
							{navegacion()}
						</div>
							...
							<div className='d-flex mt-3'>
								<Dropdown className='me-3'>
									<Dropdown.Toggle id='dropdown7' className='custom-dropdown'>
										<Image
											src='images/blue/botonsaudi.png'
											alt='Imagen'
											fluid
											onClick={() => [
												handleCountry(
									...
									<Dropdown.Menu>
										...
										<Dropdown.Item
											onClick={() => [
												setSelectedProyect('ADVISORY SERVICES'),
												setCurrentScreen(8),
											]}
										>
											ADVISORY SERVICES
								...
								<Dropdown>
									<Dropdown.Toggle id='dropdown8' className='custom-dropdown'>
										<Image
											src='images/blue/botonoman.png'
											alt='Imagen'
											fluid
											onClick={() => [
												handleCountry(
													'OMAN',
													'line-OMAN-' + ipadSource,
													'point-oman'
												),
											]}
										/>
							...
							<div className='d-flex mt-3'>
								<Dropdown className='me-3'>
									<Dropdown.Toggle id='dropdown9' className='custom-dropdown'>
										<Image
											src='images/blue/botonturkey.png'
											alt='Imagen'
											fluid
											onClick={() => [
												handleCountry(
													'TURKEY',
													'line-TURKEY-' + ipadSource,
													'point-turkey'
												),
											]}
										/>
				...
				<div>
					...
					selectedProyect === 'RENEWABLE ENERGY' ? (
						<div>
							...
							<div>
								<img
									src='images/blue/UZBE/botonuzbe.png'
									alt='Imagen'
									style={{
										width: '47.56%',
										height: '7%',
									...
									onClick={() => [
										handleCompany(9, 'SHAMOL', 'box-renewable-' + ipadSource),
									]}
								/>
							</div>
						</div>
					...
					{selectedCountry === 'UAE' && selectedProyect === 'CLEAN' ? (
						<div>
							...
							<div>
								<img
									src='images/blue/UAE/botonrail.png'
									alt='Imagen'
									style={{
										width: '70%',
										height: '7%',
									...
									onClick={() => [
										handleCompany(9, 'RAIL', 'box-clean-' + ipadSource),
									]}
								/>
							</div>
						</div>
					...
					selectedProyect === 'RENEWABLE ENERGY' ? (
						<div>
							...
							<div>
								<img
									src='images/blue/OMAN/botonoman.png'
									alt='Imagen'
									style={{
										width: '61%',
										height: '7%',
									...
									onClick={() => [
										handleCompany(9, 'SOLAR', 'box-renewable-' + ipadSource),
									]}
								/>
							</div>
						</div>
					...
					selectedProyect === 'RENEWABLE ENERGY' ? (
						<div>
							...
							<div>
								<img
									src='images/blue/KSA/botonshuaibah.png'
									alt='Imagen'
									style={{
										width: '70%',
										height: '7%',
									...
									onClick={() => [
										handleCompany(9, 'SHUAIBAH', 'box-renewable-' + ipadSource),
									]}
								/>
								<img
									src='images/blue/KSA/botonneom.png'
									alt='Imagen'
									style={{
										width: '70%',
										height: '7%',
									...
									onClick={() => [
										handleCompany(9, 'NEOM', 'box-renewable-' + ipadSource),
									]}
								/>
							</div>
						</div>
					...
					{selectedCountry === 'KSA' &&
					selectedProyect === 'ADVISORY SERVICES' ? (
						<div>
							<Image alt='' src='images/blue/KSA/advisory.png' fluid />
							{navegacion()}
							<div>
								<img
									src='images/blue/KSA/botonpublic.png'
									alt='Imagen'
									style={{
										width: '70%',
										height: '7%',
									...
									onClick={() => [
										handleCompany(9, 'PUBLIC', 'box-advisory-' + ipadSource),
									]}
								/>
							</div>
						</div>
					...
					{selectedCountry === 'TURKEY' && selectedProyect === 'LINKED' ? (
						<div>
							...
							<div>
								<img
									src='images/blue/TURKEY/botonturkey.png'
									alt='Imagen'
									style={{
										width: '35.4%',
										height: '7%',
